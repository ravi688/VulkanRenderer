...
RENDERER_API function_signature(VkDeviceMemory, vk_get_device_memory_for_buffer, VkDevice device, VkPhysicalDevice physicalDevice, VkBuffer buffer, VkMemoryPropertyFlags memoryProperties);
...
// RENDERER_API function_signature(const char*, vk_physical_device_type_to_string, VkPhysicalDeviceType* deviceType);
