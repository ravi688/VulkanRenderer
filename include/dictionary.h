...
function_signature(dictionary_t, __dictionary_create, u32 key_size, u32 value_size, buf_ucount_t capacity, bool (*key_comparer)(void* compare_key, void* key));
...
function_signature(void, dictionary_get_at, dictionary_t* dictionary, buf_ucount_t index, void* out_key, void* out_value);
...
function_signature(bool, dictionary_try_get_value, dictionary_t* dictionary, void* key, void* out_value);
#define dictionary_get_key_at(...) define_alias_function_macro(dictionary_get_key_at, __VA_ARGS__)
function_signature(void, dictionary_get_key_at, dictionary_t* dictionary, buf_ucount_t index, void* out_key);
#define dictionary_get_key_ptr_at(...) define_alias_function_macro(dictionary_get_key_ptr_at, __VA_ARGS__)
function_signature(void*, dictionary_get_key_ptr_at, dictionary_t* dictionary, buf_ucount_t index);
#define dictionary_get_value_at(...) define_alias_function_macro(dictionary_get_value_at, __VA_ARGS__)
function_signature(void, dictionary_get_value_at, dictionary_t* dictionary, buf_ucount_t index, void* out_value);
#define dictionary_get_value_ptr_at(...) define_alias_function_macro(dictionary_get_value_ptr_at, __VA_ARGS__)
function_signature(void*, dictionary_get_value_ptr_at, dictionary_t* dictionary, buf_ucount_t index);
...
function_signature(buf_ucount_t, dictionary_get_count, dictionary_t* dictionary);
#define dictionary_get_capacity(...) define_alias_function_macro(dictionary_get_capacity, __VA_ARGS__)
function_signature(buf_ucount_t, dictionary_get_capacity, dictionary_t* dictionary);


// setters
#define dictionary_set_at(...) define_alias_function_macro(dictionary_set_at, __VA_ARGS__)
function_signature(void, dictionary_set_at, dictionary_t* dictionary, buf_ucount_t index, void* in_key, void* in_value);
...
function_signature(void, dictionary_set_value_at, dictionary_t* dictionary, buf_ucount_t index, void* in_value);
...
function_signature(buf_ucount_t, dictionary_find_index_of, dictionary_t* dictionary, void* key);
...
bool dictionary_key_comparer_u16(void* v1, void* v2);
bool dictionary_key_comparer_u32(void* v1, void* v2);
bool dictionary_key_comparer_buf_ucount_t(void* v1, void* v2);
bool dictionary_key_comparer_u8(void* v1, void* v2);
bool dictionary_key_comparer_s16(void* v1, void* v2);
bool dictionary_key_comparer_s32(void* v1, void* v2);
bool dictionary_key_comparer_s64(void* v1, void* v2);
bool dictionary_key_comparer_s8(void* v1, void* v2);
bool dictionary_key_comparer_float(void* v1, void* v2);
bool dictionary_key_comparer_double(void* v1, void* v2);
bool dictionary_key_comparer_string(void* v1, void* v2);
