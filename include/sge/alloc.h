...
#else
#	warning "[alloc.h] None of MEMORY_ALLOCATION_SAFETY_LEVEL_0, MEMORY_ALLOCATION_SAFETY_LEVEL_1, or MEMORY_ALLOCATION_SAFETY_LEVEL_2 is defined; using MEMORY_ALLOCATION_SAFETY_LEVEL_0 "
#	define USE_STDLIB /*MEMORY_ALLOCATION_SAFETY_LEVEL_0 */
#endif
