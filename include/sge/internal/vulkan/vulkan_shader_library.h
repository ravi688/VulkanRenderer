...
#include <sge/internal/vulkan/vulkan_handles.h> 		// vulkan_shader_handle_t
...
/* creates vulkan shader module from pipeline descriptions, render pass descriptions, and vertex buffer layout informations. */
...
/* loads an already compiled .sb data and creates vulkan shader module from it */
...
/* loads a raw .v3dshader source text data, compiles it by invoking vsc internally, and then creates vulkan shader module from it */
