...
#include <sge/internal/vulkan/vulkan_types.h> 		// vulkan_render_target_render_technique_t
#include <sge/internal/vulkan/vulkan_descriptor_set.h> 	// vulkan_descriptor_set_t
