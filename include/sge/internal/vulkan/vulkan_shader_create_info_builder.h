...
SGE_API vulkan_shader_create_info_builder_t* vulkan_shader_create_info_builder_create_inverse(memory_allocator_t* allocator, vulkan_shader_create_info_t* descriptions, u32 description_count);
