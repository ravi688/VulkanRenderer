...
#include <bufferlib/buffer.h>
	...
	#include <sge/internal/opengl/opengl_shader.h>
	...
	#include <sge/internal/directx/directx_shader.h>
	...
	#include <sge/internal/metal/metal_shader.h>
...
SGE_API shader_t* shader_load(renderer_t* renderer, const char* file_path);
SGE_API void shader_destroy(shader_t* shader);
SGE_API void shader_release_resources(shader_t* shader);
