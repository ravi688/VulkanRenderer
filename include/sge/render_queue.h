...
/* this is used in render_scene_create_from_mask() */
typedef enum render_queue_type_bits_t
{
	RENDER_QUEUE_TYPE_BACKGROUND_BIT = BIT64(RENDER_QUEUE_TYPE_BACKGROUND),
	RENDER_QUEUE_TYPE_GEOMETRY_BIT = BIT64(RENDER_QUEUE_TYPE_GEOMETRY),
	RENDER_QUEUE_TYPE_ALPH_TESTED_BIT = BIT64(RENDER_QUEUE_TYPE_ALPH_TESTED),
	RENDER_QUEUE_TYPE_GEOMETRY_LAST_BIT = BIT64(RENDER_QUEUE_TYPE_GEOMETRY_LAST),
	RENDER_QUEUE_TYPE_TRANSPARENT_BIT = BIT64(RENDER_QUEUE_TYPE_TRANSPARENT),
	RENDER_QUEUE_TYPE_OVERLAY_BIT = BIT64(RENDER_QUEUE_TYPE_OVERLAY),
	RENDER_QUEUE_TYPE_QUEUE0_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE0),
	RENDER_QUEUE_TYPE_QUEUE1_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE1),
	RENDER_QUEUE_TYPE_QUEUE2_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE2),
	RENDER_QUEUE_TYPE_QUEUE3_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE3),
	RENDER_QUEUE_TYPE_QUEUE4_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE4),
	RENDER_QUEUE_TYPE_QUEUE5_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE5),
	RENDER_QUEUE_TYPE_QUEUE6_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE6),
	RENDER_QUEUE_TYPE_QUEUE7_BIT = BIT64(RENDER_QUEUE_TYPE_QUEUE7)
} render_queue_type_bits_t;
