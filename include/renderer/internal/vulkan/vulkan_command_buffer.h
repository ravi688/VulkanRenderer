...
static RENDERER_API inline void vulkan_command_buffer_reset(VkCommandBuffer buffer, VkCommandBufferResetFlags flags) { vkCall(vkResetCommandBuffer(buffer, flags)); }
static RENDERER_API inline void vulkan_command_buffer_end(VkCommandBuffer buffer) { vkCall(vkEndCommandBuffer(buffer)); }
