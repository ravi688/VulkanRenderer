/*
	***This is computer generated notice - Do not modify it***
	...
	File: point_light_shadows.load.c is a part of VulkanRenderer
...
TEST_DATA(POINT_LIGHT_SHADOWS_LOAD)
{
...
TEST_ON_SGE_INITIALIZE(POINT_LIGHT_SHADOWS_LOAD)
{
...
TEST_ON_TERMINATE(POINT_LIGHT_SHADOWS_LOAD)
{
...
TEST_ON_UPDATE(POINT_LIGHT_SHADOWS_LOAD)
{
	if(kbhit())
	{
		getch();
...
TEST_ON_RENDER(POINT_LIGHT_SHADOWS_LOAD)
{
