/*
	***This is computer generated notice - Do not modify it***
	...
	File: environment_reflections.load.c is a part of VulkanRenderer
...
TEST_DATA(ENVIRONMENT_REFLECTIONS_LOAD)
{
...
TEST_ON_SGE_INITIALIZE(ENVIORNMENT_REFLECTIONS_LOAD)
{
...
TEST_ON_UPDATE(ENVIRONMENT_REFLECTIONS_LOAD)
{
...
TEST_ON_RENDER(ENVIRONMENT_REFLECTIONS_LOAD)
{
