/*
	***This is computer generated notice - Do not modify it***
	...
	File: depth_cube_render_texture.c is a part of VulkanRenderer
...
TEST_ON_INITIALIZE(DEPTH_CUBE_RENDER_TEXTURE)
{
	...
	this->material = material_library_getH(mlib, 
							material_library_create_materialH(mlib, 
							shader_library_create_shader_from_preset(slib, 
								SHADER_LIBRARY_SHADER_PRESET_REFLECTION_DEPTH), "MyMaterial"));
...
TEST_ON_UPDATE(DEPTH_CUBE_RENDER_TEXTURE)
{
...
TEST_ON_RENDER(DEPTH_CUBE_RENDER_TEXTURE)
{
	camera_set_active(this->camera, false);
