/*
	***This is computer generated notice - Do not modify it***
	...
	File: bitmap_text.load.c is a part of VulkanRenderer
...
TEST_ON_SGE_INITIALIZE(BITMAP_TEXT_LOAD)
{
	...
	{
		.window_name = "BITMAP_TEXT_LOAD (press any key to switch from Screen space to World space and vice versa",
		.window_width = 800,
		.window_height = 800,
		.is_resizable = true,
		.is_fullscreen = false,
...
TEST_ON_INITIALIZE(BITMAP_TEXT_LOAD)
{
	...
	this->text_material = material_library_getH(mlib,
						 	...
						 	shader_library_load_shader(slib, "shaders/builtins/bitmap_text_shader.sb"),
...
TEST_ON_TERMINATE(BITMAP_TEXT_LOAD)
{
...
TEST_ON_UPDATE(BITMAP_TEXT_LOAD)
{
...
TEST_ON_RENDER(BITMAP_TEXT_LOAD)
{
