/*
	***This is computer generated notice - Do not modify it***
	...
	File: TID-14.case2.c is a part of VulkanRenderer
...
SETUP_TEST(TID_14_CASE_2);

TEST_ON_RENDERER_INITIALIZE(TID_14_CASE_2)
{
	return (renderer_initialization_data_t)
	{
		.window_name = "TID_14_CASE_2",
		.window_width = 800,
		.window_height = 800,
		.is_resizable = true,
		.is_fullscreen = false
...
TEST_ON_INITIALIZE(TID_14_CASE_2)
{
	...
	this->material = material_library_getH(mlib, 
							...
							shader_library_load_shader(slib, 
								"shaders/presets/TID-14.case2.sb"), "MyMaterial"));
...
TEST_ON_TERMINATE(TID_14_CASE_2)
{
