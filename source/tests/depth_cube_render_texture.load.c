/*
	***This is computer generated notice - Do not modify it***
	...
	File: depth_cube_render_texture.load.c is a part of VulkanRenderer
...
SETUP_TEST(DEPTH_CUBE_RENDER_TEXTURE_LOAD);

TEST_ON_RENDERER_INITIALIZE(DEPTH_CUBE_RENDER_TEXTURE_LOAD)
{
	return (renderer_initialization_data_t)
	{
		.window_name = "DEPTH_CUBE_RENDER_TEXTURE_LOAD",
		.window_width = 800,
		.window_height = 800,
		.is_resizable = true,
		.is_fullscreen = false
...
TEST_ON_INITIALIZE(DEPTH_CUBE_RENDER_TEXTURE_LOAD)
{
	this->angle = 0;
	...
	camera_set_render_target(this->offscreenCamera, CAMERA_RENDER_TARGET_TYPE_DEPTH, this->environmentMap);
...
TEST_ON_TERMINATE(DEPTH_CUBE_RENDER_TEXTURE_LOAD)
{
...
TEST_ON_UPDATE(DEPTH_CUBE_RENDER_TEXTURE_LOAD)
{
...
TEST_ON_RENDER(DEPTH_CUBE_RENDER_TEXTURE_LOAD)
{
	camera_set_active(this->camera, false);
