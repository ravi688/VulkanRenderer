...
TEST_ON_SGE_INITIALIZE(TID_48_CASE_5)
{
...
TEST_ON_INITIALIZE(TID_48_CASE_5)
{
	...
	render_scene_add_camera(this->scene, this->depth_present_camera);
	render_scene_add_camera(this->scene, this->offscreen_camera);
