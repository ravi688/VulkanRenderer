/*
	***This is computer generated notice - Do not modify it***
	...
	File: TID-48.case1.c is a part of VulkanRenderer
...
SETUP_TEST(TID_48_CASE_1);

TEST_ON_RENDERER_INITIALIZE(TID_48_CASE_1)
{
	return (renderer_initialization_data_t)
	{
		.window_name = "TID_48_CASE_1",
		.window_width = 800,
		.window_height = 800,
		.is_resizable = true,
		.is_fullscreen = false
...
TEST_ON_INITIALIZE(TID_48_CASE_1)
{
...
TEST_ON_TERMINATE(TID_48_CASE_1)
{
