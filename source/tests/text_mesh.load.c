/*
	***This is computer generated notice - Do not modify it***
	...
	File: text_mesh.load.c is a part of VulkanRenderer
...
SETUP_TEST(TEXT_MESH_LOAD);

TEST_ON_RENDERER_INITIALIZE(TEXT_MESH_LOAD)
{
	return (renderer_initialization_data_t)
	{
		.window_name = "TEXT_MESH_LOAD (press any key to switch from Screen space to World space and vice versa",
		.window_width = 800,
		.window_height = 800,
		.is_resizable = true,
		.is_fullscreen = false
...
TEST_ON_INITIALIZE(TEXT_MESH_LOAD)
{
	...
	this->text_material = material_library_getH(mlib,
							...
							shader_library_load_shader(slib, "shaders/builtins/text_mesh_shader.sb"),
							"TextMeshShader"));
...
TEST_ON_TERMINATE(TEXT_MESH_LOAD)
{
