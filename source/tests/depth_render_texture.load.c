/*
	***This is computer generated notice - Do not modify it***
	...
	File: depth_render_texture.load.c is a part of VulkanRenderer
...
TEST_ON_SGE_INITIALIZE(DEPTH_RENDER_TEXTURE_LOAD)
{
...
TEST_ON_INITIALIZE(DEPTH_RENDER_TEXTURE_LOAD)
{
	...
	this->shaderH = shader_library_load_shader(this->slib, "shaders/presets/diffuse_test.sb");
...
TEST_ON_UPDATE(DEPTH_RENDER_TEXTURE_LOAD)
{	
	if(kbhit())
	{
		getch();
...
TEST_ON_RENDER(DEPTH_RENDER_TEXTURE_LOAD)
{	
