...
function_signature(void, dictionary_get_key_at, dictionary_t* dictionary, u64 index, void* out_key)
{
	CALLTRACE_BEGIN();
	check_pre_condition(dictionary);
...
function_signature(void*, dictionary_get_key_ptr_at, dictionary_t* dictionary, u64 index)
{
	CALLTRACE_BEGIN();
	check_pre_condition(dictionary);
...
bool dictionary_key_comparer_u64(void* v1, void* v2)
{
