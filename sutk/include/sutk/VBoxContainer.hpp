...
namespace SUTK
{
	...
	public:
		VBoxContainer(UIDriver& driver, Container* parent = NULL, bool isLayoutLocked = false, bool isLayoutIgnore = false, UIDriver::Layer layer = UIDriver::InvalidLayer) noexcept;
