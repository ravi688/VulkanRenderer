...
namespace SUTK
{
	...
	public:
		DynamicVListContainer(UIDriver& driver, Container* parent, bool isLayoutIgnore = false, Layer layer = InvalidLayer, u32 poolSize = 7) noexcept;
	...
	template<ContainerT T>
	DynamicVListContainer<T>::DynamicVListContainer(UIDriver& driver, Container* parent, bool isLayoutIgnore, Layer layer, u32 poolSize) noexcept : VBoxContainer(driver, parent, true, isLayoutIgnore, layer),
