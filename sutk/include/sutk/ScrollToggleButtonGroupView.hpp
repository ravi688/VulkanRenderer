...
namespace SUTK
{
	...
	public:
		ScrollToggleButtonGroupView(UIDriver& driver, Container* parent, bool isLayoutIgnore = false, Layer layer = InvalidLayer, u32 poolSize = 7, GfxDriverObjectHandleType textGroup = GFX_DRIVER_OBJECT_NULL_HANDLE) noexcept;
