...
namespace SUTK
{
	...
	public:
		HBoxContainer(UIDriver& driver, Container* parent = NULL, bool isLayoutLocked = false, bool isLayoutIgnore = false, UIDriver::Layer layer = UIDriver::InvalidLayer) noexcept;
