...
namespace SUTK
{
	...
	void RoundRectTest::initialize(SGE::Driver& driver)
	{
		...
		Container* emptyContainer = m_uiDriver->createContainer<Container>(rootContainer, false, 100);
		...
		m_renderRectContainer = m_uiDriver->createContainer<RenderableContainer>(emptyContainer, false, 10000);
