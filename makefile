...
#Flags and Defines
DEBUG_DEFINES = -DHPML_DEBUG_MODE -DCALLTRACE_DEBUG -DLOG_DEBUG -DGLOBAL_DEBUG -DDEBUG
RELEASE_DEFINES = -DHPML_RELEASE_MODE -DLOG_RELEASE -DCALLTRACE_RELEASE -DGLOBAL_RELEASE -DRELEASE
# Supported switches
...
ifeq ($(VALIDATION),1)
	DEFINES += -DENABLE_VULKAN_VALIDATION_LAYERS
endif
